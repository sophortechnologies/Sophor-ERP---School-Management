...
const permissions = [
  ...
  { code: 'student:read:own',       resource: 'student',       action: 'read',       scope: 'own',   name: 'Read Own Student Profile' },
  ...
  { code: 'employee:view',          resource: 'employee',      action: 'view',       scope: 'all',   name: 'View Employees' },
  ...
  { code: 'attendance:view',        resource: 'attendance',    action: 'view',       scope: 'all',   name: 'View All Attendance' },
  ...
  { code: 'budget:view',            resource: 'budget',        action: 'view',       scope: 'all',   name: 'View Budgets' },
  ...
  { code: 'budget:submit',          resource: 'budget',        action: 'submit',     scope: 'all',   name: 'Submit Budget for Approval' },
  ...
  { code: 'asset:view',             resource: 'asset',         action: 'view',       scope: 'all',   name: 'View Assets' },
  ...
  { code: 'asset:assign',           resource: 'asset',         action: 'assign',     scope: 'all',   name: 'Assign Asset to User' },
  { code: 'asset:maintain',         resource: 'asset',         action: 'maintain',   scope: 'all',   name: 'Schedule Asset Maintenance' },
  { code: 'asset:dispose',          resource: 'asset',         action: 'dispose',    scope: 'all',   name: 'Dispose Asset' },
  { code: 'asset:depreciate',       resource: 'asset',         action: 'depreciate', scope: 'all',   name: 'Run Asset Depreciation' },
  ...
  // Payslips
  { code: 'payslip:view',           resource: 'payslip',       action: 'view',       scope: 'all',   name: 'View Any Payslip' },
  { code: 'payslip:view:own',       resource: 'payslip',       action: 'view',       scope: 'own',   name: 'View Own Payslip' },
  { code: 'payslip:download',       resource: 'payslip',       action: 'download',   scope: 'all',   name: 'Download Payslip PDF' },
  ...
  { code: 'leave:view',             resource: 'leave',         action: 'view',       scope: 'all',   name: 'View Leave Requests' },
  { code: 'leave:read:own',         resource: 'leave',         action: 'read',       scope: 'own',   name: 'Read Own Leave' },
  { code: 'leave:approve',          resource: 'leave',         action: 'approve',    scope: 'all',   name: 'Approve or Reject Leave' },
  ...
  { code: 'communication:read',     resource: 'communication', action: 'read',       scope: 'own',   name: 'Read Own Messages' },
...
const roles = [
  ...
  { code: 'PARENT',      name: 'PARENT',      description: 'Parent - children profile, grades, attendance, bills',      isSystem: false },
];
...
const rolePermissions: Record<string, string[]> = {
  ...
  ADMIN: [
    ...
    'employee:create', 'employee:read', 'employee:view', 'employee:update', 'employee:delete',
    'exam:create', 'exam:read', 'exam:update', 'exam:delete', 'exam:publish',
    'grade:create', 'grade:read', 'grade:update', 'grade:delete', 'grade:verify',
    'attendance:create', 'attendance:read', 'attendance:view', 'attendance:read:all', 'attendance:update', 'attendance:delete', 'attendance:mark',
    'leave:apply', 'leave:read', 'leave:view', 'leave:read:own', 'leave:approve', 'leave:cancel',
    'billing:create', 'billing:read', 'billing:update', 'billing:delete',
    'payment:create', 'payment:read', 'payment:update', 'payment:delete',
    'budget:create', 'budget:read', 'budget:view', 'budget:update', 'budget:submit', 'budget:approve', 'budget:transfer', 'budget:manage',
    'asset:create', 'asset:read', 'asset:view', 'asset:update', 'asset:delete', 'asset:assign', 'asset:maintain', 'asset:dispose', 'asset:depreciate',
  ...
  FINANCE: [
    ...
    'payment:create', 'payment:read', 'payment:update', 'payment:delete',
    'budget:create', 'budget:read', 'budget:view', 'budget:update', 'budget:submit', 'budget:approve', 'budget:transfer', 'budget:manage',
    'asset:create', 'asset:read', 'asset:view', 'asset:update', 'asset:assign', 'asset:maintain', 'asset:dispose', 'asset:depreciate',
  ...
  HR: [
    'config:read',
    'employee:create', 'employee:read', 'employee:view', 'employee:update',
    'staff:create', 'staff:read', 'staff:update',
    'teacher:read',
    'attendance:mark', 'attendance:view', 'attendance:read:all', 'attendance:update',
    'leave:read', 'leave:view', 'leave:approve',
  ...
  HOD: [
    ...
    'attendance:read:all', 'attendance:view',
    'exam:read', 'grade:read',
    'budget:create', 'budget:read', 'budget:view', 'budget:update', 'budget:submit',
    'leave:read', 'leave:view', 'leave:approve',
    'report:read', 'report:export',
    'notification:read', 'communication:send', 'communication:read',
  ],
...
async function main() {
  ...
  // Step 1: Permissions
  // Delete and recreate — permissions are pure reference data, no user data is lost.
  ...
  const roleByCode     = (code: string) => allRoles.find(r => r.code === code)!;
  ...
  console.log('--------------------------------------------------');
  for (const u of defaultUsers) {
    console.log('  ' + u.role.padEnd(12) + u.email.padEnd(32) + u.password);
  }
  console.log('--------------------------------------------------');
